...
public class HomeActivity extends AppCompatActivity {
    ...
    {
        String intro = getString(R.string.result_intro);
        String over = getString(R.string.over);
        String below = getString(R.string.below);
        ...
        weightDif = weight - w;
        if(weightDif<0)
            result = "Hello "+firstname+" "+lastname+", \n" + intro +" \n" + below + " " + Math.abs(weightDif)+"kg:gain";
        else
            result = "Hello "+firstname+" "+lastname+", \n" + intro +" \n" + over + " " + Math.abs(weightDif)+"kg:loose";
