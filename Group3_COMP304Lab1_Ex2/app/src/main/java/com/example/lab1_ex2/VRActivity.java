...
public class VRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = (TextView) findViewById(R.id.vr_activity_lc);
        textView.append("\n onCreate executed");

        // create the toast message for the executed life cycle method
        Toast.makeText(getBaseContext(),"VR Activity onCreate executed", Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        ...
        Toast.makeText(getBaseContext(),"VR Activity onStart executed", Toast.LENGTH_SHORT).show();
    ...
    public void onRestart() {
        ...
        Toast.makeText(getBaseContext(),"VR Activity onRestart executed", Toast.LENGTH_SHORT).show();
    ...
    public void onResume() {
        ...
        Toast.makeText(getBaseContext(),"VR Activity onResume executed", Toast.LENGTH_SHORT).show();
    ...
    public void onPause() {
        ...
        Toast.makeText(getBaseContext(),"VR Activity onPause executed", Toast.LENGTH_SHORT).show();
    ...
    public void onStop() {
        ...
        Toast.makeText(getBaseContext(),"VR Activity onStop executed", Toast.LENGTH_SHORT).show();
    ...
    public void onDestroy() {
        ...
        Toast.makeText(getBaseContext(),"VR Activity onDestroy executed", Toast.LENGTH_SHORT).show();
